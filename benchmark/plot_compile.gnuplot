reset session
set terminal svg enhanced background rgb '#0D1117' size 780,213 font "Arial,14"
...
plot $Data using (0.5*$2):0:(0.5*$2):(myBoxWidth/2.):($3+1):ytic(1) with boxxy lc var, \
     $Data using ($2):0:(sprintf("%d ms", $2)) with labels left offset char 0.5,0 tc rgb '#a0a0b0' font ",11"
