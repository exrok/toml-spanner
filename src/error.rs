...
/// An error from parsing or converting TOML.
///
...
pub enum ErrorKind {
    ...
    /// A custom error, typically generated by a [`FromToml`](crate::FromToml)
    /// implementation.
...
/// An error produced during [`ToToml`](crate::ToToml) conversion or TOML
/// emission.
///
/// Returned by [`to_string`](crate::to_string),
/// [`to_string_with_config`](crate::to_string_with_config), and
/// [`ToToml::to_toml`](crate::ToToml::to_toml).
#[cfg(feature = "to-toml")]
